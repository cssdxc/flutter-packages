...
protocol PigeonApiDelegateWKWebsiteDataStore {
  ...
  func initWithIdentifier(pigeonApi: PigeonApiWKWebsiteDataStore, identifier: String?) throws -> WKWebsiteDataStore
...
final class PigeonApiWKWebsiteDataStore: PigeonApiProtocolWKWebsiteDataStore  {
  ...
  static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiWKWebsiteDataStore?) {
    ...
    let initWithIdentifierChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.webview_flutter_wkwebview.WKWebsiteDataStore.initWithIdentifier", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
